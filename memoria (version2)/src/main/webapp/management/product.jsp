 ...
 <main>
        ...
        <div class="modal-bg">
            <div class="modal">
                <h3>상품 정보 수정</h3>
                <div class="exitBtn">
                    <img src="/management_modify/imgFolder/exitBtn.png">
                </div>
                ...
                <table>
                    ...
                    <tr>
                        <th>재고</th>
                            <td>
                                <ul>
                                    <li><input type="text" class="md-stock"  placeholder="50ml" disabled></li>
                                    <li><input type="text" class="md-stock"  placeholder="75ml" disabled></li>
                                    <li><input type="text" class="md-stock"  placeholder="100ml" disabled></li>
                                </ul>
                            </td>   
