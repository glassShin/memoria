...
public class Naver_Sens_V2 {
	...
	public void send_msg(String tel, String rand) {
        ...
        // 개인 인증키
        String accessKey = "RUgWspTJsT8yt2SMvk3K";
        // 2차 인증을 위해 서비스마다 할당되는 service secret
        String secretKey = "OE5YAtnqHD1VrxE19wat3BD1lz8ADryVkRu9Oem2";
        // 프로젝트에 할당된 SMS 서비스 ID
        String serviceId = "ncp:sms:kr:314858986186:memoria";
        // 요청 method
        String method = "POST";
        ...
        bodyJson.put("content", "본인인증 메세지");
        
        // 발신번호 * 사전에 인증/등록된 번호만 사용할 수 있습니다.
        bodyJson.put("from","01044902721");		
